...
#define RCC_APB2Periph_AFIO              ((uint32_t)0x00000001)                                     // 选择 IO
#define RCC_APB2Periph_GPIOA             ((uint32_t)0x00000004)                                     // 选择 IO
#define RCC_APB2Periph_GPIOB             ((uint32_t)0x00000008)                                     // 选择 IO
#define RCC_APB2Periph_GPIOC             ((uint32_t)0x00000010)                                     // 选择 IO
#define RCC_APB2Periph_GPIOD             ((uint32_t)0x00000020)                                     // 选择 IO
#define RCC_APB2Periph_GPIOE             ((uint32_t)0x00000040)                                     // 选择 IO
#define RCC_APB2Periph_GPIOF             ((uint32_t)0x00000080)                                     // 选择 IO
#define RCC_APB2Periph_GPIOG             ((uint32_t)0x00000100)                                     // 选择 IO
...
#define IS_RCC_APB2_PERIPH(PERIPH) ((((PERIPH) & 0xFFC00002) == 0x00) && ((PERIPH) != 0x00))       // 选择 使能IO ↑↑↑
/**
  * @}
  */ 
...
void RCC_APB2PeriphClockCmd(uint32_t RCC_APB2Periph, FunctionalState NewState);    // 一 使能IO时钟
