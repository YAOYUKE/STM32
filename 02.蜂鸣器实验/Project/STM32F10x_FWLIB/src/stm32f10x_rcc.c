...
/**
  ...
  * @retval None
  */
void RCC_APB2PeriphClockCmd(uint32_t RCC_APB2Periph, FunctionalState NewState)     // 使能时钟
{
  /* Check the parameters */
  assert_param(IS_RCC_APB2_PERIPH(RCC_APB2Periph));                                 // 选择 IO
  assert_param(IS_FUNCTIONAL_STATE(NewState));                                      // 设置 使能
  if (NewState != DISABLE)
  {
